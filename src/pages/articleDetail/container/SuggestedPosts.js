...
const SuggestedPosts = ({ clsName, header, posts = [], tags }) => {
  return (
    <div
      className={`w-full shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] rounded-lg p-4 ${clsName}`}
    >
        ...
        {posts.map((item) => (
          ...
          >
            <img
              ...
              alt={item.title}
            />
            <div className="text-sm text-dark-hard font-roboto font-medium">
      ...
      <h2 className="font-roboto font-medium mt-8 text-dark-hard md:text-xl">
        Tags
      </h2>
      {tags.length === 0 ? (
