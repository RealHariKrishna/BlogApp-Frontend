...
const ArticleCard = ({ post, className }) => {
  return (
    <div
      className={`shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] rounded-xl overflow-hidden ${className}`}
    >
      ...
      <div className="p-5">
        ...
        <div className="flex justify-between flex-nowrap items-center mt-6">
              ...
              <div className="flex items-center gap-x-2">
                ...
                >
                  {post.user.verified ? (
                    ...
                    <IoCloseOutline className="w-1.5 h-1.5 text-red-500" />
                  )}
                </span>
          ...
          <span className="font-bold text-dark-light text-sm italic md:text-base">
