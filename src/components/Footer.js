...
import { FaTelegram, FaHeart } from "react-icons/fa6";
import { images } from "../constants";

const Footer = () => {
  return (
    <section className="bg-dark-hard">
      <footer className="container mx-auto grid grid-cols-10 px-5 py-10 gap-y-10 gap-x-5 md:pt-20 md:grid-cols-12 lg:grid-cols-11 lg:gap-x-10">
        ...
        <div className="col-span-10 md:order-first md:col-span-4 lg:col-span-3 lg:ml-3">
          <img
            src={images.logo}
            alt="logo"
